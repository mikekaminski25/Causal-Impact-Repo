...
quarterly has the lowerst p value, but I'm a bit reluctant to use and is more for informational purposes.  Daily has the next lowest, but no seasonality and monthly are pretty close.  Hyperparameter tuning will be done for daily seasonality.
```{r}
